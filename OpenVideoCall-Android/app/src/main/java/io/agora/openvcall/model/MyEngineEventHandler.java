...
public class MyEngineEventHandler {
     ...
     */
    public void onRemoteVideoStats(int stats) {
     ...
     */
    public void onAudioVolumeIndication(String[] speakerInfos, int totalVolume) {
     ...
     */
    public void onLastmileProbeResult(int result) {
    ...
    public void onError(int error) {
       // log.debug("onError " + error + " " + RtcEngine.getErrorDescription(error));
        ...
        while (it.hasNext()) {
            AGEventHandler handler = it.next();
            if (handler instanceof DuringCallEventHandler) {
                ((DuringCallEventHandler) handler).onExtraCallback(AGEventHandler.EVENT_TYPE_ON_AGORA_MEDIA_ERROR, error, error);
            }
        }
    }
